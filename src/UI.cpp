...
namespace kvejken::ui
{
    ...
    static void draw_main_menu()
    {
        ...
        renderer::draw_text(u8"Maturitetni izdelek naredil Gal Končar", glm::vec2(1920 / 2, y), 48, glm::vec4(1.0f), Align::Center);
        y += 80;
    ...
    static void draw_keybinds_menu()
    {
        ...
        draw_keybind_input(u8"Počep", &settings::get().key_slide, y); y += 80;
